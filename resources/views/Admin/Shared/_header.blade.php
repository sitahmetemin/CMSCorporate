...
<head>
    ...
    <meta name="description" content="Laravel kurumsal CMS" />
    <meta name="keywords" content="Kurumsal CMS" />
    <meta name="author" content="Ahmet Emin ŞİT" />
    <!-- Favicon icon -->
...
<div id="pcoded" class="pcoded">
    ...
    <div class="pcoded-container navbar-wrapper">
        ...
        @include('Admin.Shared._rightSideBar')
        <div class="pcoded-main-container">
            <div class="pcoded-wrapper">
                @include('Admin.Shared._leftSideBar')
                            ...
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    <div class="page-header-title">
                                        ...
                                        <p class="m-b-0">@yield('titleDescription')</p>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="#!">Dashboard Analytics</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
