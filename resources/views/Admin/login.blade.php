                    ...
                    <div class="auth-box card">
                        <div class="card-block">
                            ...
                            <div class="form-group form-primary">
                                ...
                                <label class="float-label">Kullanıcı Adın</label>
                            </div>
                            <div class="form-group form-primary">
                                <input type="password" name="password" class="form-control" required>
                                <span class="form-bar"></span>
                                <label class="float-label">Şifren</label>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-10">
                                    ...
                                    <p class="text-inverse text-left"><a href="index.html"><b>Web Sitesine Geri Dön</b></a></p>
                                </div>
                                <div class="col-md-2">
